    ...
    return (
        <div className="navbar" id='navbar'>
            <div className="font-navbar" id='logo'>
                <nav id='logo-font'>
                    <a href="https://github.com/orgs/CursedNet/people" id='item-butt' className="item-butt">Devs</a>
                    <a href="https://github.com/CursedNet" className="item-butt">GitHub</a>
                    <a href="-" className="item-butt">Docs</a>
                    <a href="-" className="item-butt">Plugin</a>
                    <a href='https://discord.gg/Ug9jv9kFWx' className='item-butt-discord'>
